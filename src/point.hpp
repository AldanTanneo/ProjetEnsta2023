...
namespace Geometry {
     ...
     *
     * @tparam RealType The kind of real representing the coordinates of the
     * point
     */
    ...
    struct Point {
        ...
        /**
         * @brief Convert the point in human readable string (for output on
         * terminal or file)
         *
        ...
        //@{
        /**
         * @brief Compute the cartesian distance between the current point and a
         * point
         * p
         *
