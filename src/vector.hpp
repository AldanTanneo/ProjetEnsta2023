...
namespace Geometry {
    ...
    struct Vector {
         ...
         * @param t_y Ordinate
         */
        Vector(RealType t_x, RealType t_y) : x(t_x), y(t_y) {}
        /**
         ...
         */
        Vector(const Point<RealType> & p1, const Point<RealType> & p2)
         ...
         */
        double operator|(const Vector & u) const { return x * u.x + y * u.y; }
        /**
         ...
         */
        Vector operator+(const Vector & u) { return { x + u.x, y + u.y }; }
        /**
         * @brief Return the difference between the current vector with a second
         * vector
         *
         * @param u The second vector
        ...
        Vector operator-(const Vector & u) { return { x - u.x, y - u.y }; }
        /**
         * @brief Return a human readable string which represent the current
         * vector
         *
        ...
        /**
         * @brief Return the direct orthogonal vector relative to the current
         * vector
         *
     ...
     */
    template <typename RealType>
    Vector<RealType> operator*(RealType scalar, const Vector<RealType> & u) {
     ...
     */
    template <typename RealType>
    Point<RealType> operator+(const Point<RealType> & a_point, const Vector<RealType> & a_vector) {
